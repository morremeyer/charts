...
:warning: This chart is not production ready. It does not allow access to the IRC port from outside of the cluster yet. Please wait for version 0.2.0 before you use this chart.
