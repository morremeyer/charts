...
| backupJob.backup.image.tag | string | `"0.13.1"` |  |
...
| backupJob.init | object | `{"image":{"pullPolicy":"IfNotPresent","repository":"restic/restic","tag":"0.13.1"},"resources":{}}` | Configuration for the repository init container |
...
| cleanupJob.image.tag | string | `"0.13.1"` |  |
